 ...
 *
 * Disassembly of SSDT-8-UsbCTabl.aml, Thu Oct 29 16:05:17 2020
 *
            ...
            Method (_DSM, 4, Serialized)  // _DSM: Device-Specific Method
            {
                If (LEqual (Arg0, ToUUID ("6f8398c2-7ca4-11e4-ad36-631042b5008f")))
                {
                    Switch (ToInteger (Arg2))
                    {
                        ...
                        Case (One)
                        {
                            \_SB.PCI0.LPCB.H_EC.MBWR (0x20, MGO0)
                            \_SB.PCI0.LPCB.H_EC.MBWR (0x21, MGO1)
                            \_SB.PCI0.LPCB.H_EC.MBWR (0x22, MGO2)
                            \_SB.PCI0.LPCB.H_EC.MBWR (0x23, MGO3)
                            \_SB.PCI0.LPCB.H_EC.MBWR (0x24, MGO4)
                            \_SB.PCI0.LPCB.H_EC.MBWR (0x25, MGO5)
                            \_SB.PCI0.LPCB.H_EC.MBWR (0x26, MGO6)
                            \_SB.PCI0.LPCB.H_EC.MBWR (0x27, MGO7)
                            \_SB.PCI0.LPCB.H_EC.MBWR (0x28, MGO8)
                            \_SB.PCI0.LPCB.H_EC.MBWR (0x29, MGO9)
                            \_SB.PCI0.LPCB.H_EC.MBWR (0x2A, MGOA)
                            \_SB.PCI0.LPCB.H_EC.MBWR (0x2B, MGOB)
                            \_SB.PCI0.LPCB.H_EC.MBWR (0x2C, MGOC)
                            \_SB.PCI0.LPCB.H_EC.MBWR (0x2D, MGOD)
                            \_SB.PCI0.LPCB.H_EC.MBWR (0x2E, MGOE)
                            \_SB.PCI0.LPCB.H_EC.MBWR (0x2F, MGOF)
                        ...
                        Case (0x02)
                        {
                            Store (\_SB.PCI0.LPCB.H_EC.MBRD (0x10), MGI0)
                            Store (\_SB.PCI0.LPCB.H_EC.MBRD (0x11), MGI1)
                            Store (\_SB.PCI0.LPCB.H_EC.MBRD (0x12), MGI2)
                            Store (\_SB.PCI0.LPCB.H_EC.MBRD (0x13), MGI3)
                            Store (\_SB.PCI0.LPCB.H_EC.MBRD (0x14), MGI4)
                            Store (\_SB.PCI0.LPCB.H_EC.MBRD (0x15), MGI5)
                            Store (\_SB.PCI0.LPCB.H_EC.MBRD (0x16), MGI6)
                            Store (\_SB.PCI0.LPCB.H_EC.MBRD (0x17), MGI7)
                            Store (\_SB.PCI0.LPCB.H_EC.MBRD (0x18), MGI8)
                            Store (\_SB.PCI0.LPCB.H_EC.MBRD (0x19), MGI9)
                            Store (\_SB.PCI0.LPCB.H_EC.MBRD (0x1A), MGIA)
                            Store (\_SB.PCI0.LPCB.H_EC.MBRD (0x1B), MGIB)
                            Store (\_SB.PCI0.LPCB.H_EC.MBRD (0x1C), MGIC)
                            Store (\_SB.PCI0.LPCB.H_EC.MBRD (0x1D), MGID)
                            Store (\_SB.PCI0.LPCB.H_EC.MBRD (0x1E), MGIE)
                            Store (\_SB.PCI0.LPCB.H_EC.MBRD (0x1F), MGIF)
