 ...
 *
 * Disassembly of SSDT-7-xh_whld4.aml, Thu Oct 29 16:05:17 2020
 *
 * Original Table Header:
 *     Signature        "SSDT"
 *     Length           0x00002AFD (11005)
 *     Revision         0x02
 *     Checksum         0x46
 *     OEM ID           "LGE   "
 ...
 */
DefinitionBlock ("", "SSDT", 2, "LGE   ", "xh_whld4", 0x00000000)
{
    ...
    External (N01I, MethodObj)    // 0 Arguments (from opcode)
    ...
    Scope (\_SB.PCI0.XHC.RHUB)
    {
        ...
        Name (H7TC, Zero)
        Name (H7CR, Zero)
        If (LOr (LOr (LEqual (\XMID, Zero), LEqual (\XMID, 0x04)), LOr (LEqual (\XMID, 0x03), LEqual (\XMID, 0x07))))
        {
            Store (Zero, H7CN)
            Store (Zero, H7VS)
        }
